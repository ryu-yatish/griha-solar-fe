      ...
      <section className="cta">
        <div className="container">
          ...
          <div className="cta-buttons">
            <a href="tel:9356231912" className="btn btn-primary">
              <PhoneIcon />
              Call Now: 9356231912
            </a>
        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-section">
              ...
              <div className="footer-contact-item">
                <PhoneIcon />
                <a href="tel:9356231912">9356231912</a>
              </div>
              <div className="footer-contact-item">
                <MailIcon />
        ...
        <div className="popup-overlay" onClick={closeContactPopup}>
          <div className="popup-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="popup-options">
              <a href="tel:9356231912" className="popup-option popup-option-phone">
                <div className="popup-option-icon">
                  <PhoneIcon />
                </div>
                <div className="popup-option-content">
                  <h4>Call Us</h4>
                  <span>9356231912</span>
              ...
              <a href="https://wa.me/919356231912" target="_blank" rel="noopener noreferrer" className="popup-option popup-option-whatsapp">
                <div className="popup-option-icon">
